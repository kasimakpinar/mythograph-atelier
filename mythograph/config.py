...
LLAMACPP_CHAT_ENABLED = os.getenv("MYTHOGRAPH_LLAMACPP_CHAT_ENABLED", "0").strip() == "1"
LLAMACPP_RECIPE_ENABLED = os.getenv("MYTHOGRAPH_LLAMACPP_RECIPE_ENABLED", "0").strip() == "1"
