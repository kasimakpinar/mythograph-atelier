...
LLAMACPP_REPO_ID = os.getenv("MYTHOGRAPH_LLAMACPP_REPO_ID", "Triangle104/OpenReasoning-Nemotron-32B-Q4_K_M-GGUF")
LLAMACPP_FILENAME = os.getenv("MYTHOGRAPH_LLAMACPP_FILENAME", "*q4_k_m.gguf")
