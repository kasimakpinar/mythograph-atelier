...
LLM_CHAT_MAX_TOKENS = int(os.getenv("MYTHOGRAPH_LLM_CHAT_MAX_TOKENS", "420"))
LLM_RECIPE_MAX_TOKENS = int(os.getenv("MYTHOGRAPH_LLM_RECIPE_MAX_TOKENS", "1200"))
...
LLAMACPP_CHAT_ENABLED = os.getenv("MYTHOGRAPH_LLAMACPP_CHAT_ENABLED", "1").strip() == "1"
LLAMACPP_RECIPE_ENABLED = os.getenv("MYTHOGRAPH_LLAMACPP_RECIPE_ENABLED", "1").strip() == "1"
LLAMACPP_RECIPE_THINKING = os.getenv("MYTHOGRAPH_LLAMACPP_RECIPE_THINKING", "1").strip() == "1"
...
LLAMACPP_UNLOAD_AFTER_CALL = os.getenv("MYTHOGRAPH_LLAMACPP_UNLOAD_AFTER_CALL", "0").strip() == "1"
LLAMACPP_FLASH_ATTN = os.getenv("MYTHOGRAPH_LLAMACPP_FLASH_ATTN", "0").strip() == "1"
